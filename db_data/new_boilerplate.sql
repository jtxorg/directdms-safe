...
--
-- Host: 127.0.0.1    Database: directrm_db
-- ------------------------------------------------------
...
CREATE TABLE `odm_data` (
  ...
  `odm_udftbl_Medi_primary` int DEFAULT NULL,
  `odm_udftbl_Medi_secondary` int DEFAULT NULL,
  `odm_udftbl_Impor_primary` int DEFAULT NULL,
  `odm_udftbl_Impor_secondary` int DEFAULT NULL,
  `odm_udftbl_onboa_primary` int DEFAULT NULL,
  `odm_udftbl_onboa_secondary` int DEFAULT NULL,
  `odm_udftbl_Arch_primary` int DEFAULT NULL,
  `odm_udftbl_Arch_secondary` int DEFAULT NULL,
  `odm_udftbl_ranso` int DEFAULT NULL,
  `odm_udftbl_ranso_primary` int DEFAULT NULL,
  `odm_udftbl_ranso_secondary` int DEFAULT NULL,
...
--
-- Dumping routines for database 'directrm_db'
--
...
-- Dump completed on 2025-04-17 23:22:04
