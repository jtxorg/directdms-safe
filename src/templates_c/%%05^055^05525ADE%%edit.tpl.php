<?php /* Smarty version 2.6.28, created on 2025-05-08 00:17:25
         compiled from /var/www/html//templates/common/edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/var/www/html//templates/common/edit.tpl', 4, false),)), $this); ?>
<script type="text/javascript" src="functions.js"></script>

<!-- file upload formu using ENCTYPE -->
<form id="addeditform" name="main" class="display dataTable" action="<?php echo ((is_array($_tmp=$_SERVER['PHP_SELF'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
...
?>
    <input type="hidden" id="secondary<?php echo ((is_array($_tmp=$this->_tpl_vars['i'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
" value="" /> <!-- CHM hidden and onsubmit added-->
    <input type="hidden" id="tablename<?php echo ((is_array($_tmp=$this->_tpl_vars['i'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
<?php endforeach; endif; unset($_from); ?>
    <input type="hidden" id="id" name="id" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['file_id'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" />
...
" /> <!-- CHM hidden and onsubmit added-->
    <tr>
		...
		<td colspan="3"><b><?php echo ((is_array($_tmp=$this->_tpl_vars['realname'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</b></td>
    </tr>
...
?>
                <option value="<?php echo ((is_array($_tmp=$this->_tpl_vars['user']['id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" <?php if ($this->_tpl_vars['pre_selected_owner'] == $this->_tpl_vars['user']['id']): ?>selected='selected'<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['user']['last_name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
...
?>
                <option value="<?php echo ((is_array($_tmp=$this->_tpl_vars['dept']['id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" <?php if ($this->_tpl_vars['pre_selected_department'] == $this->_tpl_vars['dept']['id']): ?>selected='selected'<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['dept']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</option>
            <?php endforeach; endif; unset($_from); ?>
            </select>
        </td>
...
?>
                <option value="<?php echo ((is_array($_tmp=$this->_tpl_vars['cat']['id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" <?php if ($this->_tpl_vars['pre_selected_category'] == $this->_tpl_vars['cat']['id']): ?>selected='selected'<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['cat']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</option>
            <?php endforeach; endif; unset($_from); ?>
            </select>
        </td>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <tr>
        ...
        <td colspan="3"><input tabindex="5" type="Text" name="description" size="50" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['description'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
"/></td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3"><textarea tabindex="6" name="comment" rows="4" onchange="this.value=enforceLength(this.value, 255);"><?php echo ((is_array($_tmp=$this->_tpl_vars['comment'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</textarea></td>
    </tr>