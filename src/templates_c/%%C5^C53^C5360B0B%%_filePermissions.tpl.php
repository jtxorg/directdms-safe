...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '../../templates/common/_filePermissions.tpl', 54, false),)), $this); ?>
<?php echo '
<style>
.accordion {
   margin: 10px;   
...
?>
                    ...
                    <?php endif; ?>
                <tr>
                    <td><?php echo ((is_array($_tmp=$this->_tpl_vars['dept']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</td>
...
?>
                ...
                <tr>
                    <td><?php echo ((is_array($_tmp=$this->_tpl_vars['user']['last_name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
